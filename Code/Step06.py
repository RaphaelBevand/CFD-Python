"""
Solve the two dimensional nonlinear convection.
"""
import numpy as np
...
from Solvers import step_06 as solver # @UnresolvedImport
...
def calc_solution(courant, dx, dy, plot_3d=False):
    ...
    print("-".center(80, "-"))
    print("Nonlinear Convection (2D)".center(80))
    print("-".center(80, "-")) 
...
if __name__ == "__main__":
    calc_solution(courant=0.1, dx=0.025, dy=0.025, plot_3d=False)
