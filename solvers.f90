...
SUBROUTINE LINEAR_CONVECTION(SPEED, DX, DT, U, M)
IMPLICIT NONE
INTEGER, INTENT(IN) :: M
DOUBLE PRECISION, INTENT(IN) :: SPEED, DX, DT
DOUBLE PRECISION, DIMENSION(M), INTENT(INOUT) :: U

INTEGER :: I
DOUBLE PRECISION, DIMENSION(M) :: UK

UK = U

DO I = 2, M
    U(I) = UK(I) - SPEED*DT/DX*(UK(I) - UK(I-1))
END DO

END SUBROUTINE LINEAR_CONVECTION

! ==============================================================================

SUBROUTINE NONLINEAR_CONVECTION(DX, DT, U, M)
IMPLICIT NONE
INTEGER, INTENT(IN) :: M
...
DO I = 2, M
    U(I) = UK(I) - UK(I) * DT/DX * (UK(I) - UK(I-1))
END DO

END SUBROUTINE NONLINEAR_CONVECTION

! ==============================================================================

SUBROUTINE DIFFUSION(NU, DX, DT, U, M)
IMPLICIT NONE
INTEGER, INTENT(IN) :: M
...
DO I = 2, M-1
    U(I) = UK(I) + NU*DT/DX/DX * (UK(I+1) - 2.0D0*UK(I) + UK(I-1))
END DO
...
SUBROUTINE CONVECTION_DIFFUSION(NU, DX, DT, U, M)
IMPLICIT NONE
INTEGER, INTENT(IN) :: M
DOUBLE PRECISION, INTENT(IN) :: NU, DX, DT
DOUBLE PRECISION, DIMENSION(M), INTENT(INOUT) :: U
...
DO I = 2, M-1
    U(I) = UK(I) - UK(I) * DT/DX * (UK(I) - UK(I-1)) &
        + NU*DT/DX/DX * (UK(I+1) - 2.0D0*UK(I) + UK(I-1))
END DO

! PERIODIC BOUNDARY CONDITION.

U(1) = UK(1) - UK(1) * DT/DX * (UK(1) - UK(M-1)) &
    + NU*DT/DX/DX * (UK(2) - 2.0D0*UK(1) + UK(M-1))
U(M) = U(1)

END SUBROUTINE CONVECTION_DIFFUSION

END MODULE TRANSPORT_1D
